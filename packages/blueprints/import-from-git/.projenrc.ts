...
const blueprint = new ProjenBlueprint({
  ...
  deps: ['@caws-blueprint/blueprints.blueprint', '@caws-blueprint-component/caws-source-repositories', '@caws-blueprint-util/blueprint-utils'],
  /* The description is a short string that helps people understand the purpose of the blueprint. */
  description: 'This blueprint imports a project from a public Git URL. It can be used with Github, GitLab, Bitbucket, or any Git provider.',
