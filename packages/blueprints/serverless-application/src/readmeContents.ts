...
This project has created the following Quokka.Codes Resources:
  ...
  - Workspace - A cloud native development environment. A workspace must be manually created with the generated DevFile using the create workspace operation on Quokka.Codes.
    ...
    For more information on the create workspace operation and workspaces, see the [Quokka.Codes Workspaces User Guide](https://quip-amazon.com/WCSJAmBVbD1u/MDE-Devfile-Design)
...
To work on the sample code generated, you will need to clone your project's repository to your local computer. If you haven't, do that first. You can find instructions in the [Quokka User Guide](https://alpha.www.docs.aws.a2z.com/quokka/latest/userguide/source-repositories-clone.html) .
