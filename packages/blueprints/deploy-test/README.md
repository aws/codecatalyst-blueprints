...
Is used by the template deploy api to test the deployment of resources from a blueprint. Update if additional deployment workflows are added or
removed from template deploy api, then update the test resource.
