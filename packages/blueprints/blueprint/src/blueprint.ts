...
import { DurableStorage } from './durable-storage/durable-storage';
...
export class Blueprint extends Project {
  ...
  /**
   * Used for preserving information between synthesis requests
   */
  public durableState: DurableStorage;
