...
export class Auth extends Construct {
  ...
  constructor(scope: Construct, id: string, props: AuthProps) {
    ...
    const userPool = new UserPool(this, "UserPool", {
      ...
      // Disable if identity providers are configured (or explicitly denied)
      selfSignUpEnabled: props.idp.isExist() ? false : scope.node.tryGetContext('enableSelfRegistration'),
      signInAliases: {
        username: false,
        email: true,
      },
